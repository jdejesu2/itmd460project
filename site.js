...
(function($) {
  var music = new Audio('audio/youvegotafriendinme.wav');
  ...
  $('#aboutpagepic').hover(function() {
    $('#aboutpagepic').attr('src', 'images/vamosgroup.jpg');
  },
  function()
  {
    $('#aboutpagepic').attr('src', 'images/VAMOS.jpg');
  });

  $('#aboutpagepic').on('click', sing);
